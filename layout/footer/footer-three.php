<div class="footer-stars-animation-wrapper-footer-two">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-wrapper contact-wrap">
                            ...
                            <ul class="ft-link tmp-scroll-trigger animation-order-1 tmp-link-animation">
                                <li><span class="ft-icon"><i class="fa-solid fa-phone"></i></span><a href="#">017345 678
                                        9101</a></li>
                                <li><span class="ft-icon"><i class="fa-solid fa-location-dot"></i></span>Cumilla,Bangladesh</li>
                                <li><span class="ft-icon"><i class="fa-solid fa-envelope"></i></span><a href="#">abcd@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-wrapper tmp-scroll-trigger animation-order-1">
                        <p class="copy-right-para">© rowDevs <script>
    ...
    <div class="slider-bg-light">
        <img class="blocksync-scroll-trigger fade_in animation-order-8" src="assets/images/banner/shape/light-left.svg" alt="Top Light Shape">
    </div>
