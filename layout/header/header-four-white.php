            ...
            <div class="col-lg-12">
                <div class="header-fluid-main-wrapper">
                    <div class="left-area">
                        <div class="logo">
                            <a href="index.php">
                                <img class="logo-dark" src="assets/images/logo/dark-logo-virtuo.png" alt="Virtuo - Personal Portfolio HTML Template for developers and freelancers">
                    ...
                    <div class="right-area">
                        ...
                        <a class="tmp-btn btn-border tmp-modern-button" href="#">
